---
title: "Infant Mental Timeline Study initial analysis"
output:
...
#Load sample data
```{r sample report, warning = FALSE, message = FALSE, echo=FALSE}
file_path <- #file_path
...
###Test trial looking
```{r, reshape data, warning = FALSE, message = FALSE, echo=FALS}
# Test trials only
...
```{r, data quality check, warning = FALSE, message = FALSE, echo=FALSE}
...
```{r Cook's Distance, warning = FALSE, message = FALSE, echo=FALSE}
...
#Data exploration
###Habituation trials
```{r habituation trials, warning = FALSE, message = FALSE, echo=FALSE}
#Do an initial look:
...
###Test trials
```{r test trials,warning = FALSE, message = FALSE, echo=FALSE}
...
```
#Stats and plots
```{r stats, warning = FALSE, message = FALSE, echo=FALSE, fig.show='hide',}
...
```{r test looking plots, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
